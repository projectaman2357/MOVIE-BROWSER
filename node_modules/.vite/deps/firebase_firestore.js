...
var Q2 = class {
    ...
    setTimeout(() => {
      if (!this.auth) {
        ...
        t3 ? o(t3) : (
          ...
          (C2("FirebaseAuthCredentialsProvider", "Auth not yet detected"), i.resolve(), i = new U2())
        );
      }
    }, 0), r();
  }
  getToken() {
    ...
    return this.forceRefresh = false, this.auth ? this.auth.getToken(e).then((e2) => (
      ...
      this.i !== t2 ? (C2("FirebaseAuthCredentialsProvider", "getToken aborted due to token change."), this.getToken()) : e2 ? (M2("string" == typeof e2.accessToken), new q2(e2.accessToken, this.currentUser)) : null
...
function ft(t2, e) {
  ...
  if (0 !== n) return n;
  for (let s = 0; s < Math.min(t2.fields.length, e.fields.length); ++s) if (n = _t(t2.fields[s], e.fields[s]), 0 !== n) return n;
...
var Rt = class _Rt {
  constructor(t2, e) {
     ...
     */
    this.P = new U2(), this.transaction.oncomplete = () => {
      this.P.resolve();
...
var kt = class {
  ...
  it(t2, e) {
    ...
    return At.doWhile(() => true === i && s > 0, () => this.localStore.indexManager.getNextCollectionGroupToUpdate(t2).next((e2) => {
      if (null !== e2 && !n.has(e2)) return C2("IndexBackiller", `Processing collection: ${e2}`), this.rt(t2, e2, s).next((t3) => {
        s -= t3, n.add(e2);
      });
      i = false;
    })).next(() => e - s);
...
var Bt = class _Bt {
  ...
  insert(t2, e) {
    return new _Bt(this.comparator, this.root.insert(t2, e, this.comparator).copy(null, null, Ut.BLACK, null, null));
  }
  // Returns a copy of the map, with the specified key removed.
  remove(t2) {
    return new _Bt(this.comparator, this.root.remove(t2, this.comparator).copy(null, null, Ut.BLACK, null, null));
  }
...
var Ut = class _Ut {
  constructor(t2, e, n, s, i) {
    this.key = t2, this.value = e, this.color = null != n ? n : _Ut.RED, this.left = null != s ? s : _Ut.EMPTY, this.right = null != i ? i : _Ut.EMPTY, this.size = this.left.size + 1 + this.right.size;
  }
  // Returns a copy of the current node, optionally replacing pieces of it.
  copy(t2, e, n, s, i) {
    return new _Ut(null != t2 ? t2 : this.key, null != e ? e : this.value, null != n ? n : this.color, null != s ? s : this.left, null != i ? i : this.right);
  }
  isEmpty() {
    return false;
  }
  ...
  removeMin() {
    if (this.left.isEmpty()) return _Ut.EMPTY;
    let t2 = this;
  ...
  remove(t2, e) {
    ...
    if (e(t2, s.key) < 0) s.left.isEmpty() || s.left.isRed() || s.left.left.isRed() || (s = s.moveRedLeft()), s = s.copy(null, null, null, s.left.remove(t2, e), null);
      ...
      if (s.left.isRed() && (s = s.rotateRight()), s.right.isEmpty() || s.right.isRed() || s.right.left.isRed() || (s = s.moveRedRight()), 0 === e(t2, s.key)) {
        if (s.right.isEmpty()) return _Ut.EMPTY;
  ...
  rotateLeft() {
    const t2 = this.copy(null, null, _Ut.RED, null, this.right.left);
    return this.right.copy(null, null, this.color, t2, null);
  }
  rotateRight() {
    const t2 = this.copy(null, null, _Ut.RED, this.left.right, null);
...
Ut.EMPTY = new // Represents an empty node (a leaf node in the Red-Black Tree).
class {
  constructor() {
    this.size = 0;
  }
...
var qt = class _qt {
  ...
  isEqual(t2) {
    if (!(t2 instanceof _qt)) return false;
  ...
  copy(t2) {
    const e = new _qt(this.comparator);
    return e.data = t2, e;
  }
};
var Kt = class {
...
var ne = class _ne {
  ...
  isEqual(t2) {
    return t2 instanceof _ne && t2.projectId === this.projectId && t2.database === this.database;
  }
};
function se(t2) {
  return null == t2;
...
function ae(t2, e) {
  ...
  switch (n) {
    ...
    case 2:
      return function(t3, e2) {
        if ("integerValue" in t3 && "integerValue" in e2) return Jt(t3.integerValue) === Jt(e2.integerValue);
    ...
    case 10:
      return function(t3, e2) {
        ...
        if (Mt(n2) !== Mt(s)) return false;
        for (const t4 in n2) if (n2.hasOwnProperty(t4) && (void 0 === s[t4] || !ae(n2[t4], s[t4]))) return false;
        return true;
      }(t2, e);
    default:
      return O2();
...
function le(t2, e) {
  ...
  switch (n) {
    ...
    case 10:
      return function(t3, e2) {
        if (t3 === oe.mapValue && e2 === oe.mapValue) return 0;
        if (t3 === oe.mapValue) return 1;
        if (e2 === oe.mapValue) return -1;
...
function fe(t2, e) {
  if ("string" == typeof t2 && "string" == typeof e && t2.length === e.length) return Z(t2, e);
...
function _e(t2) {
  return "nullValue" in t2 ? "null" : "booleanValue" in t2 ? "" + t2.booleanValue : "integerValue" in t2 ? "" + t2.integerValue : "doubleValue" in t2 ? "" + t2.doubleValue : "timestampValue" in t2 ? function(t3) {
    ...
    let e2 = "[", n2 = true;
    for (const s of t3.values || []) n2 ? n2 = false : e2 += ",", e2 += _e(s);
    return e2 + "]";
  }(t2.arrayValue) : "mapValue" in t2 ? function(t3) {
    const e2 = Object.keys(t3.fields || {}).sort();
    let n2 = "{", s = true;
    for (const i of e2) s ? s = false : n2 += ",", n2 += `${i}:${_e(t3.fields[i])}`;
    return n2 + "}";
  }(t2.mapValue) : O2();
  var e, n;
}
...
function Te(t2) {
  ...
  if (t2.arrayValue) {
    ...
    for (let n = 0; n < (t2.arrayValue.values || []).length; ++n) e.arrayValue.values[n] = Te(t2.arrayValue.values[n]);
    return e;
  }
...
var ve = class _ve {
  ...
  field(t2) {
    ...
    {
      let e = this.value;
      for (let n = 0; n < t2.length - 1; ++n) if (e = (e.mapValue.fields || {})[t2.get(n)], !Ie(e)) return null;
...
var Se = class _Se {
  ...
  isEqual(t2) {
    return t2 instanceof _Se && this.key.isEqual(t2.key) && this.version.isEqual(t2.version) && this.documentType === t2.documentType && this.documentState === t2.documentState && this.data.isEqual(t2.data);
  }
  mutableCopy() {
    return new _Se(this.key, this.documentType, this.version, this.readTime, this.data.clone(), this.documentState);
  }
  toString() {
...
function ke(t2, e) {
  ...
  for (let n2 = 0; n2 < t2.orderBy.length; n2++) if (!Je(t2.orderBy[n2], e.orderBy[n2])) return false;
  if (t2.filters.length !== e.filters.length) return false;
  for (let i = 0; i < t2.filters.length; i++) if (n = t2.filters[i], s = e.filters[i], n.op !== s.op || !n.field.isEqual(s.field) || !ae(n.value, s.value)) return false;
  var n, s;
...
var Be = class _Be extends class {
} {
  constructor(t2, e, n) {
  ...
  static create(t2, e, n) {
    return t2.isKeyField() ? "in" === e || "not-in" === e ? this.lt(t2, e, n) : new Le(t2, e, n) : "array-contains" === e ? new Ge(t2, n) : "in" === e ? new Qe(t2, n) : "not-in" === e ? new je(t2, n) : "array-contains-any" === e ? new We(t2, n) : new _Be(t2, e, n);
  }
  static lt(t2, e, n) {
...
function Xe(t2, e) {
  ...
  for (let n = 0; n < t2.position.length; n++) {
    if (!ae(t2.position[n], e.position[n])) return false;
  }
  return true;
}
var Ze = class {
  ...
  constructor(t2, e = null, n = [], s = [], i = null, r = "F", o = null, u = null) {
    this.path = t2, this.collectionGroup = e, this.explicitOrderBy = n, this.filters = s, this.limit = i, this.limitType = r, this.startAt = o, this.endAt = u, this._t = null, // The corresponding `Target` of this `Query` instance.
...
function rn(t2) {
  for (const e of t2.filters) if (e.dt()) return e.field;
  return null;
}
function on(t2) {
...
function un(t2) {
  ...
  if (null === e._t) {
    ...
    if (null !== t3 && null === n)
      t3.isKeyField() || e._t.push(new He(t3)), e._t.push(new He(
        ut.keyField(),
        "asc"
        /* ASCENDING */
      ));
      ...
      let t4 = false;
      for (const n2 of e.explicitOrderBy) e._t.push(n2), n2.field.isKeyField() && (t4 = true);
      if (!t4) {
...
function cn(t2) {
  const e = $(t2);
  if (!e.wt) if ("F" === e.limitType) e.wt = Ce(e.path, e.collectionGroup, un(e), e.filters, e.limit, e.startAt, e.endAt);
  else {
    const t3 = [];
...
function dn(t2, e) {
  return e.isFoundDocument() && function(t3, e2) {
    ...
    */
    ...
    }(t3.startAt, un(t3), e2)) return false;
    if (t3.endAt && !function(t4, e3, n) {
      const s = Ye(t4, e3, n);
      return t4.inclusive ? s >= 0 : s > 0;
    }(t3.endAt, un(t3), e2)) return false;
    return true;
  }(t2, e);
}
function _n(t2) {
...
function Pn(t2, e) {
  const n = Cn(e);
  for (const e2 of t2.elements) n.some((t3) => ae(t3, e2)) || n.push(e2);
  return {
    arrayValue: {
      values: n
    }
...
function Vn(t2, e) {
  let n = Cn(e);
  for (const e2 of t2.elements) n = n.filter((t3) => !ae(t3, e2));
  return {
    arrayValue: {
      values: n
    }
...
function $n(t2, e) {
  ...
  if (null === e) return t2.isNoDocument() ? new zn(t2.key, On.none()) : new Kn(t2.key, t2.data, On.none());
  {
...
function Ln(t2, e, n, s) {
  return t2 instanceof Kn ? function(t3, e2, n2, s2) {
    ...
    if (!Mn(t3.precondition, e2)) return n2;
    const i = Wn(t3.fieldTransforms, s2, e2), r = e2.data;
    if (r.setAll(Qn(t3)), r.setAll(i), e2.convertToFoundDocument(e2.version, r).setHasLocalMutations(), null === n2) return null;
    return n2.unionWith(t3.fieldMask.fields).unionWith(t3.fieldTransforms.map((t4) => t4.field));
  }(t2, e, n, s) : function(t3, e2, n2) {
    if (Mn(t3.precondition, e2)) return e2.convertToNoDocument(e2.version).setHasLocalMutations(), null;
    return n2;
  }(t2, e, n);
}
function Un(t2, e) {
...
var ws = class _ws {
  ...
  static createSynthesizedRemoteEventForCurrentChange(t2, e, n) {
    const s = /* @__PURE__ */ new Map();
    return s.set(t2, ms.createSynthesizedTargetChangeForCurrentChange(t2, e, n)), new _ws(st.min(), s, _s(), ss(), fs());
  }
};
var ms = class _ms {
  constructor(t2, e, n, s, i) {
...
var Is = class {
  constructor() {
     ...
     */
    this.bt = As(), /** See public getters for explanations of these fields. */
    this.Pt = Wt.EMPTY_BYTE_STRING, this.vt = false, /**
...
var Ts = class {
  constructor(t2) {
    this.Bt = t2, /** The internal state of all tracked targets. */
    this.Lt = /* @__PURE__ */ new Map(), /** Keeps track of the documents to update since the last raised snapshot. */
    this.Ut = ss(), /** A mapping of document keys to their set of target IDs. */
    this.qt = Es(), /**
   ...
   */
  Gt(t2) {
    for (const e of t2.Tt) t2.Et && t2.Et.isFoundDocument() ? this.Qt(e, t2.Et) : this.jt(e, t2.key, t2.Et);
    for (const e of t2.removedTargetIds) this.jt(e, t2.key, t2.Et);
  }
  ...
  Yt(t2) {
    ...
    if (s) {
      ...
      if (Oe(t3)) if (0 === n) {
        ...
        this.Zt(e) !== n && // Existence filter mismatch: We reset the mapping and raise a new
  ...
  jt(t2, e, n) {
    ...
    this.ee(t2, e) ? s.kt(
      ...
      s.Ot(e)
    ), this.qt = this.qt.insert(e, this.ne(e).delete(t2)), n && (this.Ut = this.Ut.insert(e, n));
  }
  removeTarget(t2) {
    this.Lt.delete(t2);
  }
...
function Ks(t2, e) {
  ...
  return e.fieldTransforms.length > 0 && (n.updateTransforms = e.fieldTransforms.map((t3) => function(t4, e2) {
    ...
    if (n2 instanceof Rn) return {
      fieldPath: e2.field.canonicalString(),
      setToServerValue: "REQUEST_TIME"
    };
    if (n2 instanceof bn) return {
      fieldPath: e2.field.canonicalString(),
      appendMissingElements: {
        values: n2.elements
      }
    };
    if (n2 instanceof vn) return {
      fieldPath: e2.field.canonicalString(),
      removeAllFromArray: {
        values: n2.elements
      }
...
function Gs(t2, e) {
  const n = e.currentDocument ? function(t3) {
    ...
    let n2 = null;
    if ("setToServerValue" in e3) M2("REQUEST_TIME" === e3.setToServerValue), n2 = new Rn();
      ...
      n2 = new vn(t4);
    } else "increment" in e3 ? n2 = new Sn(t3, e3.increment) : O2();
...
function Qs(t2, e) {
  return t2 && t2.length > 0 ? (M2(void 0 !== e), t2.map((t3) => function(t4, e2) {
    ...
    (n = Ds(e2)), new kn(n, t4.transformResults || []);
  }(t3, e))) : [];
}
function js(t2, e) {
  return {
...
function Ws(t2, e) {
  ...
  const i = function(t3) {
    ...
    const e2 = t3.map((t4) => (
      ...
      function(t5) {
        if ("==" === t5.op) {
          if (pe(t5.value)) return {
            unaryFilter: {
              field: Zs(t5.field),
              op: "IS_NAN"
            }
          };
          if (ye(t5.value)) return {
            unaryFilter: {
              field: Zs(t5.field),
              op: "IS_NULL"
            }
...
function ri(t2) {
  let e = "";
  for (let n = 0; n < t2.length; n++) e.length > 0 && (e = ui(e)), e = oi(t2.get(n), e);
  return ui(e);
}
function oi(t2, e) {
  let n = e;
...
function ci(t2) {
  const e = t2.length;
  if (M2(e >= 2), 2 === e) return M2("" === t2.charAt(0) && "" === t2.charAt(1)), rt.emptyPath();
  const n = e - 2, s = [];
  let i = "";
  for (let r = 0; r < e; ) {
...
var ki = class {
  ...
  applyToLocalView(t2, e) {
    for (const n of this.baseMutations) n.key.isEqual(t2.key) && (e = Ln(n, t2, e, this.localWriteTime));
    for (const n of this.mutations) n.key.isEqual(t2.key) && (e = Ln(n, t2, e, this.localWriteTime));
    return e;
  }
  /**
...
var Fi = class _Fi {
  ...
  withSequenceNumber(t2) {
    return new _Fi(this.target, this.targetId, this.purpose, t2, this.snapshotVersion, this.lastLimboFreeSnapshotVersion, this.resumeToken);
  }
  /**
  ...
  withResumeToken(t2, e) {
    return new _Fi(this.target, this.targetId, this.purpose, this.sequenceNumber, e, this.lastLimboFreeSnapshotVersion, t2);
  }
  /**
  ...
  withLastLimboFreeSnapshotVersion(t2) {
    return new _Fi(this.target, this.targetId, this.purpose, this.sequenceNumber, this.snapshotVersion, t2, this.resumeToken);
  }
};
var $i = class {
  constructor(t2) {
...
function Bi(t2, e) {
  let n;
  if (e.document) n = Ls(t2.re, e.document, !!e.hasCommittedMutations);
...
var nr = class {
  ...
  ce(t2, e) {
    this.ae(t2, e), // Write separator to split index values
    // (see go/firestore-storage-format#encodings).
    e.he();
  }
  ae(t2, e) {
    if ("nullValue" in t2) this.le(e, 5);
    else if ("booleanValue" in t2) this.le(e, 10), e.fe(t2.booleanValue ? 1 : 0);
    else if ("integerValue" in t2) this.le(e, 15), e.fe(Jt(t2.integerValue));
    ...
    } else if ("stringValue" in t2) this._e(t2.stringValue, e), this.we(e);
    else if ("bytesValue" in t2) this.le(e, 30), e.me(Yt(t2.bytesValue)), this.we(e);
    else if ("referenceValue" in t2) this.ge(t2.referenceValue, e);
    else if ("geoPointValue" in t2) {
      const n = t2.geoPointValue;
      this.le(e, 45), e.fe(n.latitude || 0), e.fe(n.longitude || 0);
    } else "mapValue" in t2 ? Ee(t2) ? this.le(e, Number.MAX_SAFE_INTEGER) : (this.ye(t2.mapValue, e), this.we(e)) : "arrayValue" in t2 ? (this.pe(t2.arrayValue, e), this.we(e)) : O2();
  }
  _e(t2, e) {
  ...
  ye(t2, e) {
    const n = t2.fields || {};
    this.le(e, 55);
    for (const t3 of Object.keys(n)) this._e(t3, e), this.ae(n[t3], e);
  }
  pe(t2, e) {
    const n = t2.values || [];
    this.le(e, 50);
    for (const t3 of n) this.ae(t3, e);
  }
  ge(t2, e) {
    this.le(e, 37);
...
var rr = class {
  ...
  Ve(t2) {
    for (const e of t2) {
      ...
      if (t3 < 128) this.Ae(t3);
      else if (t3 < 2048) this.Ae(960 | t3 >>> 6), this.Ae(128 | 63 & t3);
      else if (e < "\uD800" || "\uDBFF" < e) this.Ae(480 | t3 >>> 12), this.Ae(128 | 63 & t3 >>> 6), this.Ae(128 | 63 & t3);
      else {
  ...
  Se(t2) {
    for (const e of t2) {
      const t3 = e.charCodeAt(0);
      if (t3 < 128) this.Pe(t3);
      else if (t3 < 2048) this.Pe(960 | t3 >>> 6), this.Pe(128 | 63 & t3);
      else if (e < "\uD800" || "\uDBFF" < e) this.Pe(480 | t3 >>> 12), this.Pe(128 | 63 & t3 >>> 6), this.Pe(128 | 63 & t3);
      else {
        const t4 = e.codePointAt(0);
...
var ar = class _ar {
  ...
  Ke() {
    ...
    return n.set(this.directionalValue, 0), e !== t2 ? n.set([0], this.directionalValue.length) : ++n[n.length - 1], new _ar(this.indexId, this.documentKey, this.arrayValue, n);
  }
};
function hr(t2, e) {
...
var fr = class {
  ...
  We(t2) {
    ...
    if (void 0 !== this.je) {
      const t3 = n[s];
      if (!this.He(this.je, t3) || !this.Je(this.Ge[i++], t3)) return false;
      ++s;
    }
    for (; s < n.length; ++s) {
      const t3 = n[s];
      if (i >= this.Ge.length || !this.Je(this.Ge[i++], t3)) return false;
    }
    return true;
  }
  ze(t2) {
    for (const e of this.Qe) if (this.He(e, t2)) return true;
    return false;
  }
  He(t2, e) {
...
var mr = class {
  constructor(t2, e) {
     ...
     */
    this.Ze = new es((t3) => xe(t3), (t3, e2) => ke(t3, e2)), this.uid = t2.uid || "";
  }
  /**
      ...
      if (s) {
        ...
        return At.forEach(i, (i2, r) => {
          ...
          const u = function(t4, e2) {
            ...
            for (const e3 of Me(t4, n2.fieldPath)) switch (e3.op) {
            ...
            for (const s3 of lt(e2)) for (const e3 of Me(t4, s3.fieldPath)) switch (e3.op) {
              case "==":
              case "in":
  ...
  sn(t2, e, n) {
    ...
    for (const r of lt(t2)) {
      const t3 = n[i++];
      for (const n2 of s) if (this.ln(e, r.fieldPath) && ge(t3)) s = this.fn(s, r, t3);
      else {
  ...
  mn(t2, e) {
    ...
    if (null != i) {
      ...
      if (ge(r)) for (const i2 of r.arrayValue.values || []) n = n.add(new ar(e.indexId, t2.key, this.on(i2), s));
    } else n = n.add(new ar(e.indexId, t2.key, wr, s));
    return n;
  }
  /**
  ...
  createRange(t2, e, n) {
    ...
    s.push(e);
    const i = [];
    for (let t3 = 0; t3 < s.length; t3 += 2) i.push(IDBKeyRange.bound([s[t3].indexId, this.uid, s[t3].arrayValue, s[t3].directionalValue, wr, []], [s[t3 + 1].indexId, this.uid, s[t3 + 1].arrayValue, s[t3 + 1].directionalValue, wr, []]));
    return i;
  }
  getMinOffsetFromCollectionGroup(t2, e) {
...
var Ar = class _Ar {
  ...
  static withCacheSize(t2) {
    return new _Ar(t2, _Ar.DEFAULT_COLLECTION_PERCENTILE, _Ar.DEFAULT_MAX_SEQUENCE_NUMBERS_TO_COLLECT);
  }
};
function Rr(t2, e, n) {
...
var Pr = class _Pr {
  constructor(t2, e, n, s) {
    this.userId = t2, this.It = e, this.indexManager = n, this.referenceDelegate = s, /**
  ...
  Kn(t2, e) {
    ...
    return n.Z({
      ...
      0 === t3 ? (
        ...
        (i !== Ot.at && e(new ct(ci(s)), i), // set nextToReport to be this sequence number. It's the next one we
...
var Kr = class {
  ...
  zn(t2, e, n) {
    ...
    return Wr(t2).Z({
      ...
      for (; o && Jr(o, i2) < 0; ) n(o, null), o = r.getNext();
...
var Qr = class extends qr {
  ...
  constructor(t2, e) {
    ...
    // this buffer.
    this.Xn = new es((t3) => t3.toString(), (t3, e2) => t3.isEqual(e2));
  }
  applyChanges(t2) {
    const e = [];
...
function Jr(t2, e) {
  ...
  let i = 0;
  for (let t3 = 0; t3 < n.length - 2 && t3 < s.length - 2; ++t3) if (i = Z(n[t3], s[t3]), i) return i;
  ...
  getDocumentsMatchingCollectionQuery(t2, e, n) {
    ...
    return this.remoteDocumentCache.getAllFromCollection(t2, e.path, n).next((i) => (s = i, this.documentOverlayCache.getOverlaysForCollection(t2, e.path, n.largestBatchId))).next((t3) => {
      ...
      return s.forEach((s2, i) => {
        const r = t3.get(s2);
        void 0 !== r && Ln(r.mutation, i, Qt.empty(), nt.now()), // Finally, insert the documents that still match the query
        dn(e, i) && (n2 = n2.insert(s2, i));
      }), n2;
    });
  }
...
var eo = class {
  constructor() {
    this.ns = new qt(no.ss), // A set of outstanding references to a document sorted by target id.
...
var so = class {
  ...
  addMutationBatch(t2, e, n, s) {
    ...
    for (const e2 of s) this.gs = this.gs.add(new no(e2.key, i)), this.indexManager.addToCollectionParentIndex(t2, e2.key.path.popLast());
    return At.resolve(r);
  }
  lookupMutationBatch(t2, e) {
...
var io = class {
  ...
  constructor(t2) {
    ...
    this.docs = new Bt(ct.comparator), /** Size of all cached documents. */
    this.size = 0;
  }
  setIndexManager(t2) {
    this.indexManager = t2;
...
var oo = class {
  constructor(t2) {
     ...
     */
    this.Rs = new es((t3) => xe(t3), ke), /** The last received snapshot version. */
...
var _o = class __o {
  constructor(t2, e, n, s, i, r, o, u, c, a, h = 15) {
    ...
    this.si = (t3) => Promise.resolve(), !__o.C()) throw new L2(B2.UNIMPLEMENTED, "This platform is either missing IndexedDB or is known to have an incomplete implementation. Offline persistence has been disabled.");
  ...
  ui() {
    return this.runTransaction("updateClientMetadataAndTryBecomePrimary", "readwrite", (t2) => mo(t2).put({
      ...
      if (this.isPrimary) return this.fi(t2).next((t3) => {
  ...
  async yi() {
    if (this.isPrimary && !this.pi(this.ni, 18e5)) {
      ...
      if (this.oi) for (const e of t2) this.oi.removeItem(this.Ti(e.clientId));
    }
  }
  /**
  ...
  runTransaction(t2, e, n) {
    ...
    return this.ri.runTransaction(t2, s, i, (s2) => (o = new xi(s2, this.Ss ? this.Ss.next() : Ot.at), "readwrite-primary" === e ? this.fi(o).next((t3) => !!t3 || this.di(o)).next((e2) => {
      if (!e2) throw x2(`Failed to obtain primary lease for action '${t2}'.`), this.isPrimary = false, this.Hs.enqueueRetryable(() => this.si(false)), new L2(B2.FAILED_PRECONDITION, It);
      return n(o);
  ...
  Vi(t2) {
    return wo(t2).get("owner").next((t3) => {
      if (null !== t3 && this.pi(t3.leaseTimestampMs, 5e3) && !this.Ei(t3.ownerId) && !this.mi(t3) && !(this.Ys || this.allowTabSynchronization && t3.allowTabSynchronization)) throw new L2(B2.FAILED_PRECONDITION, fo);
    });
  }
  /**
...
var yo = class _yo {
  ...
  static Ci(t2, e) {
    ...
    return new _yo(t2, e.fromCache, n, s);
  }
};
var po = class {
  constructor() {
  ...
  ki(t2, e) {
    ...
    (e = an(
      ...
      "F"
      /* First */
    ), n = cn(e)), this.indexManager.getDocumentsMatchingTarget(t2, n).next((s2) => {
      const i = fs(...s2);
      return this.Ni.getDocuments(t2, i).next((s3) => this.indexManager.getMinOffset(t2, n).next((n2) => {
        const r = this.Fi(e, s3);
        return this.$i(e, r, i, n2.readTime) ? this.ki(t2, an(
          e,
          null,
          "F"
          /* First */
...
var Io = class {
  constructor(t2, e, n, s) {
    this.persistence = t2, this.Li = e, this.It = s, /**
     * Maps a targetID to data about its target.
     *
     * PORTING NOTE: We are using an immutable data structure on Web to make re-runs
     * of `applyRemoteEvent()` idempotent.
     */
    this.Ui = new Bt(Z), /** Maps a target to its targetID. */
    // TODO(wuandy): Evaluate if TargetId can be part of Target.
    this.qi = new es((t3) => xe(t3), ke), /**
...
function bo(t2, e) {
  ...
  return n.persistence.runTransaction("Apply remote event", "readwrite-primary", (t3) => {
    ...
    e.targetChanges.forEach((r2, u2) => {
      ...
      e.targetMismatches.has(u2) ? a = a.withResumeToken(Wt.EMPTY_BYTE_STRING, st.min()).withLastLimboFreeSnapshotVersion(st.min()) : r2.resumeToken.approximateByteSize() > 0 && (a = a.withResumeToken(r2.resumeToken, s)), i = i.insert(u2, a), // Update the target data if there are target changes (or if
...
function Vo(t2, e) {
  ...
  return n.persistence.runTransaction("Allocate target", "readwrite", (t3) => {
    ...
    return n.Cs.getTargetData(t3, e).next((i) => i ? (
      ...
      (s = i, At.resolve(s))
    ) : n.Cs.allocateTargetId(t3).next((i2) => (s = new Fi(e, i2, 0, t3.currentSequenceNumber), n.Cs.addTargetData(t3, s).next(() => s))));
  }).then((t3) => {
...
function Do(t2, e, n) {
  ...
  return s.persistence.runTransaction("Execute query", "readonly", (t3) => function(t4, e2, n2) {
    ...
    if (e2) return i = e2.lastLimboFreeSnapshotVersion, s.Cs.getMatchingKeysForTargetId(t3, e2.targetId).next((t4) => {
      r = t4;
    });
...
async function Oo(t2, e, n = fs()) {
  ...
  return i.persistence.runTransaction("Save named query", "readwrite", (t3) => {
    ...
    if (s.snapshotVersion.compareTo(r) >= 0) return i.Ns.saveNamedQuery(t3, e);
...
var Bo = class _Bo {
  ...
  static Zi(t2, e, n) {
    ...
    return r && s.error && (r = "string" == typeof s.error.message && "string" == typeof s.error.code, r && (i = new L2(s.error.code, s.error.message))), r ? new _Bo(t2, e, s.state, i) : (x2("SharedClientState", `Failed to parse mutation state for ID '${e}': ${n}`), null);
  }
  tr() {
    const t2 = {
      state: this.state,
...
var Lo = class _Lo {
  ...
  static Zi(t2, e) {
    ...
    return i && n.error && (i = "string" == typeof n.error.message && "string" == typeof n.error.code, i && (s = new L2(n.error.code, n.error.message))), i ? new _Lo(t2, n.state, s) : (x2("SharedClientState", `Failed to parse target state for ID '${t2}': ${e}`), null);
  }
  tr() {
    const t2 = {
      state: this.state,
...
var Uo = class _Uo {
  ...
  static Zi(t2, e) {
    ...
    for (let t3 = 0; s && t3 < n.activeTargetIds.length; ++t3) s = re(n.activeTargetIds[t3]), i = i.add(n.activeTargetIds[t3]);
    return s ? new _Uo(t2, i) : (x2("SharedClientState", `Failed to parse client data for instance '${t2}': ${e}`), null);
  }
};
var qo = class _qo {
  constructor(t2, e) {
  ...
  static Zi(t2) {
    ...
    return "object" == typeof e && -1 !== ["Unknown", "Online", "Offline"].indexOf(e.onlineState) && "string" == typeof e.clientId ? new _qo(e.clientId, e.onlineState) : (x2("SharedClientState", `Failed to parse online state: ${t2}`), null);
  }
};
var Ko = class {
  constructor() {
...
var Go = class {
  constructor(t2, e, n, s, i) {
    this.window = t2, this.Hs = e, this.persistenceKey = n, this.sr = s, this.syncEngine = null, this.onlineStateHandler = null, this.sequenceNumberHandler = null, this.ir = this.rr.bind(this), this.ur = new Bt(Z), this.started = false, /**
     * Captures WebStorage events that occur before `start()` is called. These
     * events are replayed once `WebStorageSharedClientState` is started.
     */
    this.cr = [];
    const r = n.replace(/[.*+?^${}()|[\]\\]/g, "\\$&");
    this.storage = this.window.localStorage, this.currentUser = i, this.ar = Mo(this.persistenceKey, this.sr), this.hr = /** Assembles the key for the current sequence number. */
    function(t3) {
      return `firestore_sequence_number_${t3}`;
    }(this.persistenceKey), this.ur = this.ur.insert(this.sr, new Ko()), this.lr = new RegExp(`^firestore_clients_${r}_([^_]*)$`), this.dr = new RegExp(`^firestore_mutations_${r}_(\\d+)(?:_(.*))?$`), this._r = new RegExp(`^firestore_targets_${r}_(\\d+)$`), this.wr = /** Assembles the key for the online state of the primary tab. */
    function(t3) {
  ...
  rr(t2) {
    ...
    if (e.storageArea === this.storage) {
      if (C2("SharedClientState", "EVENT", e.key, e.newValue), e.key === this.ar) return void x2("Received WebStorage notification for local change. Another client might have garbage-collected our state");
  ...
  async Cr(t2) {
    if (t2.user.uid === this.currentUser.uid) return this.syncEngine.Fr(t2.batchId, t2.state, t2.error);
          ...
          switch (o.getLastErrorCode()) {
            ...
            case ErrorCode.HTTP_ERROR:
              ...
              if (C2("Connection", 'RPC "' + t2 + '" failed with status:', s2, "response text:", o.getResponseText()), s2 > 0) {
                ...
                } else r(new L2(B2.UNKNOWN, "Server responded with status " + o.getStatus()));
              } else
  ...
  wo(t2, e, n) {
    ...
    return f(c, WebChannel.EventType.OPEN, () => {
      ...
      if (!h) {
        ...
        } else C2("Connection", "WebChannel received:", n2), l2.ro(n2);
      }
...
var eu = class {
  constructor(t2, e, n, s, i, r, o, u) {
     ...
     * close.
     */
    this.So = 0, this.Do = null, this.Co = null, this.stream = null, this.xo = new tu(t2, e);
  }
  /**
  ...
  zo(t2) {
    ...
    e.database = Fs(this.It), e.addTarget = function(t3, e2) {
      ...
      return n2 = Oe(s) ? {
        ...
        query: Ws(t3, s)
      }, n2.targetId = e2.targetId, e2.resumeToken.approximateByteSize() > 0 ? n2.resumeToken = Vs(t3, e2.resumeToken) : e2.snapshotVersion.compareTo(st.min()) > 0 && // TODO(wuandy): Consider removing above check because it is most likely true.
      // Right now, many tests depend on this behaviour though (leaving min() out
      // of serialization).
      (n2.readTime = vs(t3, e2.snapshotVersion.toTimestamp())), n2;
    }(this.It, t2);
...
var iu = class extends class {
  ...
  su() {
    if (this.nu) throw new L2(B2.FAILED_PRECONDITION, "The client has already been terminated.");
  }
...
var uu = class {
  constructor(t2, e, n, s, i) {
     ...
     */
    this.wu = [], this.mu = i, this.mu.qr((t3) => {
...
async function cu(t2) {
  if (mu(t2)) for (const e of t2.wu) await e(
    /* enabled= */
    true
  );
}
...
function lu(t2, e) {
  const n = $(t2), s = ku(n);
  n.du.delete(e), s.ko() && du(n, e), 0 === n.du.size && (s.ko() ? s.Fo() : mu(n) && // Revert to OnlineState.Unknown if the watch stream is not open and we
...
async function Iu(t2, e, n) {
  if (
    ...
    t2.gu.set(
      "Online"
      /* Online */
    ), e instanceof ps && 2 === e.state && e.cause
  )
    try {
  ...
  else if (e instanceof gs ? t2.yu.Gt(e) : e instanceof ys ? t2.yu.Yt(e) : t2.yu.Wt(e), !n.isEqual(st.min())) try {
    ...
    */
    function(t3, e3) {
      ...
      n2.targetMismatches.forEach((e4) => {
        ...
        if (!n3)
          return;
        t3.du.set(e4, n3.withResumeToken(Wt.EMPTY_BYTE_STRING, n3.snapshotVersion)), // Cause a hard reset by unwatching and rewatching immediately, but
...
async function Tu(t2, e, n) {
  ...
  await au(t2), t2.gu.set(
    "Offline"
    /* Offline */
  ), n || // Use a simple read operation to determine if IndexedDB recovered.
  // Ideally, we would expose a health check directly on SimpleDb, but
  // RemoteStore only has access to persistence through LocalStore.
  (n = () => Ro(t2.localStore)), // Probe IndexedDB periodically and re-enable network
...
async function Su(t2) {
  const e = Ou(t2);
  for (const n of t2.fu) e.Xo(n.mutations);
}
async function Du(t2, e, n) {
  const s = t2.fu.shift(), i = Oi.from(s, e, n);
  await Eu(t2, () => t2.remoteSyncer.applySuccessfulWrite(i)), // It's possible that with the completion of this mutation another
  // slot has freed up.
  await Au(t2);
}
async function Cu(t2, e) {
  e && Ou(t2).Yo && // This error affects the actual write.
  await async function(t3, e2) {
    if (n = e2.code, Zn(n) && n !== B2.ABORTED) {
      const n2 = t3.fu.shift();
      Ou(t3).Mo(), await Eu(t3, () => t3.remoteSyncer.rejectFailedWrite(n2.batchId, e2)), // It's possible that with the completion of this mutation
...
async function xu(t2, e) {
  ...
  n._u.add(
    3
    /* CredentialChange */
  ), await au(n), s && // Don't set the network status to Unknown if we are offline.
  n.gu.set(
    "Unknown"
    /* Unknown */
...
function ku(t2) {
  ...
  (t2.pu = function(t3, e, n) {
    ...
    e ? (t2.pu.Mo(), wu(t2) ? _u(t2) : t2.gu.set(
      "Unknown"
      /* Unknown */
    )) : (await t2.pu.stop(), gu(t2));
  })), t2.pu;
}
function Ou(t2) {
  ...
  (t2.Iu = function(t3, e, n) {
    ...
    await Au(t2)) : (await t2.Iu.stop(), t2.fu.length > 0 && (C2("RemoteStore", `Stopping write stream with ${t2.fu.length} pending writes`), t2.fu = []));
  })), t2.Iu;
}
var Mu = class _Mu {
  constructor(t2, e, n, s, i) {
    this.asyncQueue = t2, this.timerId = e, this.targetTimeMs = n, this.op = s, this.removalCallback = i, this.deferred = new U2(), this.then = this.deferred.promise.then.bind(this.deferred.promise), // It's normal for the deferred promise to be canceled (due to cancellation)
  ...
  static createAndSchedule(t2, e, n, s, i) {
    const r = Date.now() + n, o = new _Mu(t2, e, r, s, i);
    return o.start(n), o;
  }
  /**
...
var $u = class _$u {
  ...
  isEqual(t2) {
    if (!(t2 instanceof _$u)) return false;
    if (this.size !== t2.size) return false;
...
var Lu = class _Lu {
  ...
  isEqual(t2) {
    if (!(this.fromCache === t2.fromCache && this.hasCachedResults === t2.hasCachedResults && this.syncStateChanged === t2.syncStateChanged && this.mutatedKeys.isEqual(t2.mutatedKeys) && hn(this.query, t2.query) && this.docs.isEqual(t2.docs) && this.oldDocs.isEqual(t2.oldDocs))) return false;
...
function Qu(t2, e) {
  ...
  for (const t3 of e) {
    ...
    if (i) {
      for (const e3 of i.listeners) e3.Pu(t3) && (s = true);
      i.Au = t3;
    }
  }
  s && Wu(n);
...
var Yu = class {
  constructor(t2, e, n) {
    this.Mu = t2, this.localStore = e, this.It = n, /** Batched queries to be saved into storage */
    this.queries = [], /** Batched documents to be saved into storage */
    this.documents = [], /** The collection groups affected by this bundle. */
    this.collectionGroups = /* @__PURE__ */ new Set(), this.progress = Xu(t2);
  }
  /**
  ...
  Fu(t2) {
    ...
    if (t2.ku.namedQuery) this.queries.push(t2.ku.namedQuery);
    ...
    } else t2.ku.document && (this.documents[this.documents.length - 1].document = t2.ku.document, ++e);
  ...
  async complete() {
    ...
    for (const t3 of this.queries) await Oo(this.localStore, t3, e.get(t3.name));
...
var ec2 = class {
  constructor(t2, e) {
    this.query = t2, this.Uu = e, this.qu = null, this.hasCachedResults = false, /**
    ...
    this.Ku = fs(), /** Document Keys that have local changes */
    this.mutatedKeys = fs(), this.Gu = wn(t2), this.Qu = new $u(this.Gu);
  }
  /**
  ...
  Wu(t2, e) {
    ...
    if (t2.inorderTraversal((t3, e2) => {
      const a = s.get(t3), h = dn(this.query, e2) ? e2 : null, l2 = !!a && this.mutatedKeys.has(a.key), f = !!h && (h.hasLocalMutations || // We only consider committed mutations for documents that were
   ...
   */
  Zu(t2) {
    return !this.Uu.has(t2) && // The local store doesn't think it's a result, so it shouldn't be in limbo.
...
var ic2 = class {
  constructor(t2, e, n, s, i, r) {
    this.localStore = t2, this.remoteStore = e, this.eventManager = n, this.sharedClientState = s, this.currentUser = i, this.maxConcurrentLimboResolutions = r, this.sc = {}, this.ic = new es((t3) => ln(t3), hn), this.rc = /* @__PURE__ */ new Map(), /**
    ...
    this.lc = /* @__PURE__ */ new Map(), this.fc = Cr.vn(), this.onlineState = "Unknown", // The primary state is set to `true` or `false` immediately after Firestore
...
async function uc2(t2, e) {
  ...
  if (i.length > 1) return n.rc.set(s.targetId, i.filter((t3) => !hn(t3, e))), void n.ic.delete(e);
  ...
  } else gc2(n, s.targetId), await So(
    n.localStore,
    s.targetId,
    /*keepPersistedTargetData=*/
    true
      ...
      return n2.persistence.runTransaction("Locally write mutations", "readwrite", (t5) => {
        ...
        return n2.Gi.getEntries(t5, i).next((t6) => {
          ...
          for (const t6 of e2) {
            ...
            // exists=true
            o2.push(new Gn(t6.key, e3, Ve(e3.value.mapValue), On.exists(true)));
          }
...
async function lc2(t2, e, n) {
  ...
  if (r) {
    ...
    await ac2(s, i2), // Since this query failed, we won't want to manually unlisten to it.
    // We only remove it from bookkeeping after we successfully applied the
    // RemoteEvent. If `applyRemoteEvent()` throws, we want to re-listen to
    // this query when the RemoteStore restarts the Watch stream, which should
    // re-trigger the target failure.
    s.uc = s.uc.remove(r), s.cc.delete(e), Tc2(s);
  } else await So(
    s.localStore,
    e,
    /* keepPersistedTargetData */
...
async function fc2(t2, e) {
  ...
  try {
    ...
    mc2(
      ...
      /*error=*/
      null
    ), wc2(n, s), n.sharedClientState.updateMutationState(s, "acknowledged"), await Ec2(n, t3);
  } catch (t3) {
    await Et(t3);
  }
}
...
function gc2(t2, e, n = null) {
  ...
  for (const s of t2.rc.get(e)) t2.ic.delete(s), n && t2.sc.wc(s, n);
...
function pc2(t2, e, n) {
  for (const s of n) if (s instanceof Zu) t2.ac.addReference(s.key, e), Ic2(t2, s);
...
async function Ac2(t2, e) {
  ...
  if (!n.currentUser.isEqual(e)) {
    ...
    n.sharedClientState.handleUserChange(e, t3.removedBatchIds, t3.addedBatchIds), await Ec2(n, t3.ji);
  }
}
function Rc2(t2, e) {
...
async function vc2(t2, e, n, s) {
  ...
  null !== r ? ("pending" === n ? (
    ...
    await Au(i.remoteStore)
  ) : "acknowledged" === n || "rejected" === n ? (
    // NOTE: Both these methods are no-ops for batches that originated from
    // other clients.
    (mc2(i, e, s || null), wc2(i, e), function(t3, e2) {
...
async function Vc2(t2, e) {
  ...
  if (kc2(n), Oc2(n), true === e && true !== n.dc) {
    ...
    for (const t4 of e2) hu(n.remoteStore, t4);
    ...
    }), await e2, await Sc2(n, t3), // PORTING NOTE: Multi-Tab only.
    function(t4) {
      const e3 = $(t4);
      e3.cc.forEach((t5, n2) => {
...
var $c2 = class extends Fc2 {
  ...
  async initialize(t2) {
    ...
    await Oc2(this.Ac.syncEngine), await Au(this.Ac.remoteStore), // NOTE: This will immediately call the listener, so we make sure to
...
var Bc2 = class extends $c2 {
  ...
  gc(t2) {
    const e = Yo();
    if (!Go.C(e)) throw new L2(B2.UNIMPLEMENTED, "IndexedDB persistence is only available on platforms that support LocalStorage.");
...
var Lc2 = class {
  async initialize(t2, e) {
    this.localStore || (this.localStore = t2.localStore, this.sharedClientState = t2.sharedClientState, this.datastore = this.createDatastore(e), this.remoteStore = this.createRemoteStore(e), this.eventManager = this.createEventManager(e), this.syncEngine = this.createSyncEngine(
      ...
      /* startAsPrimary=*/
      !t2.synchronizeTabs
    ), this.sharedClientState.onlineStateHandler = (t3) => hc2(
      this.syncEngine,
      t3,
      1
      /* SharedClientState */
    ), this.remoteStore.remoteSyncer.handleCredentialChange = Ac2.bind(null, this.syncEngine), await Nu(this.remoteStore, this.syncEngine.isPrimaryClient));
  }
  ...
  createRemoteStore(t2) {
    return e = this.localStore, n = this.datastore, s = t2.asyncQueue, i = (t3) => hc2(
      this.syncEngine,
      t3,
      0
      /* RemoteStore */
  ...
  terminate() {
    return async function(t2) {
      ...
      C2("RemoteStore", "RemoteStore shutting down."), e._u.add(
        5
        /* Shutdown */
      ), await au(e), e.mu.shutdown(), // Set the OnlineState to Unknown (rather than Offline) to avoid potentially
...
var Jc2 = class {
  ...
  constructor(t2, e, n, s) {
     ...
     */
    this.type = "firestore-lite", this._persistenceKey = "(lite)", this._settings = new Hc2({}), this._settingsFrozen = false;
  }
  /**
...
function Yc2(t2, e, n, s = {}) {
  ...
  if ("firestore.googleapis.com" !== r.host && r.host !== e && N2("Host has been set in both settings() and useEmulator(), emulator host will be used"), t2._setSettings(Object.assign(Object.assign({}, r), {
    ...
    let e2, n2;
    if ("string" == typeof s.mockUserToken) e2 = s.mockUserToken, n2 = P2.MOCK_USER;
    else {
...
var Xc2 = class _Xc {
  ...
  withConverter(t2) {
    return new _Xc(this.firestore, t2, this._key);
  }
};
var Zc2 = class _Zc {
  ...
  withConverter(t2) {
    return new _Zc(this.firestore, t2, this._query);
  }
};
var ta2 = class _ta extends Zc2 {
  /** @hideconstructor */
  constructor(t2, e, n) {
    super(t2, e, en(n)), this._path = n, /** The type of this Firestore reference. */
  ...
  withConverter(t2) {
    return new _ta(this.firestore, t2, this._path);
  }
};
function ea2(t2, e, ...n) {
  ...
  {
    if (!(t2 instanceof Xc2 || t2 instanceof ta2)) throw new L2(B2.INVALID_ARGUMENT, "Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");
...
function na2(t2, e) {
  if (t2 = jc2(t2, Jc2), Uc2("collectionGroup", "collection id", e), e.indexOf("/") >= 0) throw new L2(B2.INVALID_ARGUMENT, `Invalid collection ID '${e}' passed to function collectionGroup(). Collection IDs must not contain '/'.`);
  return new Zc2(
    t2,
    /* converter= */
    null,
...
function sa2(t2, e, ...n) {
  ...
  // 'undefined' and 'null'.
  1 === arguments.length && (e = X2.R()), Uc2("doc", "path", e), t2 instanceof Jc2) {
    const s = rt.fromString(e, ...n);
...
var ca2 = class {
  constructor(t2, e) {
    this.Pc = t2, this.It = e, /** Cached bundle metadata. */
    this.metadata = new U2(), /**
...
var da2 = class {
  constructor(t2, e, n, s, i) {
    this.asyncQueue = t2, this.datastore = e, this.options = n, this.updateFunction = s, this.deferred = i, this.kc = n.maxAttempts, this.xo = new tu(
      this.asyncQueue,
      "transaction_retry"
      /* TransactionRetry */
    );
  ...
  return t2.asyncQueue.enqueue(async () => {
    ...
    return e.setNetworkEnabled(false), async function(t3) {
      ...
      e2._u.add(
        0
        /* UserDisabled */
      ), await au(e2), // Set the OnlineState to Offline so get()s return from cache, etc.
      e2.gu.set(
        "Offline"
        /* Offline */
      );
...
function xa2(t2, e, n, s) {
  const i = function(t3, e2) {
    ...
    return function(t4, e3) {
      ...
      if (t4 instanceof Uint8Array) return oa2(t4, e3);
      if (t4 instanceof ArrayBuffer) return oa2(new Uint8Array(t4), e3);
...
var ka = class {
  constructor() {
    ...
    // be changed again.
    this.Uc = false, // Operations scheduled to be queued in the future. Operations are
   ...
   */
  Zc(t2) {
    for (const e of this.qc) if (e.timerId === t2) return true;
    return false;
  }
  /**
  ...
  ta(t2) {
    return this.Xc().then(() => {
      ...
      for (const e of this.qc) if (e.skipDelay(), "all" !== t2 && e.timerId === t2) break;
      return this.Xc();
    });
  }
  /**
...
var $a2 = class extends Jc2 {
  ...
  _terminate() {
    ...
    qa2(this), this._firestoreClient.terminate();
  }
};
function Ba2(t2, e, n) {
  n || (n = "(default)");
...
function Qa2(t2, e, n) {
  ...
  return t2.asyncQueue.enqueue(async () => {
    try {
      ...
      */
      function(t4) {
        if ("FirebaseError" === t4.name) return t4.code === B2.FAILED_PRECONDITION || t4.code === B2.UNIMPLEMENTED;
...
var th = class _th {
  ...
  static fromBase64String(t2) {
    try {
      return new _th(Wt.fromBase64String(t2));
    } catch (t3) {
   ...
   */
  static fromUint8Array(t2) {
    return new _th(Wt.fromUint8Array(t2));
  }
  /**
...
var ah = class _ah {
   ...
   */
  constructor(t2, e, n, s, i, r) {
    this.settings = t2, this.databaseId = e, this.It = n, this.ignoreUndefinedProperties = s, // Minor hack: If fieldTransforms is undefined, we assume this is an
  ...
  ia(t2) {
    return new _ah(Object.assign(Object.assign({}, this.settings), t2), this.databaseId, this.It, this.ignoreUndefinedProperties, this.fieldTransforms, this.fieldMask);
  }
  ra(t2) {
    var e;
  ...
  na() {
    if (this.path) for (let t2 = 0; t2 < this.path.length; t2++) this.ua(this.path.get(t2));
  }
  ua(t2) {
    if (0 === t2.length) throw this.ha("Document fields must not be empty");
    if (ch(this.sa) && rh.test(t2)) throw this.ha('Document fields cannot begin and end with "__"');
  }
};
var hh = class {
  constructor(t2, e, n) {
...
function fh(t2, e, n, s, i, r = {}) {
  ...
  const u = Ah(s, o);
  let c, a;
  if (r.merge) c = new Qt(o.fieldMask), a = o.fieldTransforms;
...
var dh = class _dh extends sh {
  _toFieldTransform(t2) {
    if (2 !== t2.sa) throw 1 === t2.sa ? t2.ha(`${this._methodName}() can only appear at the top level of your update data`) : t2.ha(`${this._methodName}() cannot be used with set() unless you pass {merge:true}`);
    return t2.fieldMask.push(t2.path), null;
  }
  isEqual(t2) {
    return t2 instanceof _dh;
  }
};
function _h(t2, e, n) {
  return new ah({
...
var wh = class _wh extends sh {
  _toFieldTransform(t2) {
    return new xn(t2.path, new Rn());
  }
  isEqual(t2) {
    return t2 instanceof _wh;
  }
};
...
function Ih(t2, e, n, s, i, r) {
  ...
  for (let t3 = 0; t3 < r.length; t3 += 2) u.push(Ph(e, r[t3])), c.push(r[t3 + 1]);
  const a = [], h = ve.empty();
  for (let t3 = u.length - 1; t3 >= 0; --t3) if (!Dh(a, u[t3])) {
    const e2 = u[t3];
    let n2 = c[t3];
...
function Eh(t2, e) {
  ...
  if (t2 instanceof sh)
    return function(t3, e2) {
      if (!ch(e2.sa)) throw e2.ha(`${t3._methodName}() can only be used with update() and set()`);
      if (!e2.path) throw e2.ha(`${t3._methodName}() is not currently supported inside arrays`);
  ...
  if (
    ...
    if (e.settings.oa && 4 !== e.sa) throw e.ha("Nested arrays are not supported");
    return function(t3, e2) {
      const n = [];
      let s = 0;
      for (const i of t3) {
  ...
  return function(t3, e2) {
    ...
    if ("number" == typeof t3) return pn(e2.It, t3);
    ...
    if (t3 instanceof ih) return {
      geoPointValue: {
        latitude: t3.latitude,
        longitude: t3.longitude
      }
    };
    if (t3 instanceof th) return {
      bytesValue: Vs(e2.It, t3._byteString)
    };
    if (t3 instanceof Xc2) {
      const n = e2.databaseId, s = t3.firestore._databaseId;
      if (!s.isEqual(n)) throw e2.ha(`Document reference is for database ${s.projectId}/${s.database} but should be for database ${n.projectId}/${n.database}`);
      return {
...
function Ph(t2, e, n) {
  if (
    ...
    // FieldPath.
    (e = getModularInstance(e)) instanceof eh
  ) return e._internalPath;
  if ("string" == typeof e) return Vh(t2, e);
  throw Sh(
    ...
    const e = lh(t2.firestore), n = function(t3, e2, n2, s, i, r, o) {
      ...
      if (i.isKeyField()) {
        ...
        if ("in" === r || "not-in" === r) {
          Xh(o, r);
          const e3 = [];
          for (const n3 of o) e3.push(Yh(s, t3, n3));
          u = {
            arrayValue: {
              values: e3
            }
      ...
      } else "in" !== r && "not-in" !== r && "array-contains-any" !== r || Xh(o, r), u = Th(
        n2,
        e2,
        o,
        /* allowArrays= */
      ...
      return function(t4, e3) {
        if (e3.dt()) {
          const n4 = rn(t4);
          if (null !== n4 && !n4.isEqual(e3.field)) throw new L2(B2.INVALID_ARGUMENT, `Invalid query. All where filters with an inequality (<, <=, !=, not-in, >, or >=) must be on the same field. But you have inequality filters on '${n4.toString()}' and '${e3.field.toString()}'`);
          const s2 = sn(t4);
...
function Kh(t2) {
  return Wc2("limitToLast", t2), new Uh(
    "limitToLast",
    t2,
    "L"
    /* Last */
...
function Jh(t2, e, n, s) {
  if (n[0] = getModularInstance(n[0]), n[0] instanceof Ch) return function(t3, e2, n2, s2, i) {
    if (!s2) throw new L2(B2.NOT_FOUND, `Can't use a DocumentSnapshot that doesn't exist for ${n2}().`);
    const r = [];
    for (const n3 of un(t3)) if (n3.field.isKeyField()) r.push(we(e2, s2.key));
    else {
      const t4 = s2.data.field(n3.field);
      if (Xt(t4)) throw new L2(B2.INVALID_ARGUMENT, 'Invalid query. You are trying to start or end a query using a document for which the field "' + n3.field + '" is an uncommitted server timestamp. (Since the value of this field is unknown, you cannot start/end a query with it.)');
      if (null === t4) {
    ...
    return function(t3, e2, n2, s2, i2, r) {
      ...
      for (let r2 = 0; r2 < i2.length; r2++) {
        ...
        if (o[r2].field.isKeyField()) {
          ...
          if (!on(t3) && -1 !== c.indexOf("/")) throw new L2(B2.INVALID_ARGUMENT, `Invalid query. When querying a collection and ordering by documentId(), the value passed to ${s2}() must be a plain document ID, but '${c}' contains a slash.`);
...
function Yh(t2, e, n) {
  if ("string" == typeof (n = getModularInstance(n))) {
    ...
    if (!on(e) && -1 !== n.indexOf("/")) throw new L2(B2.INVALID_ARGUMENT, `Invalid query. When querying a collection by documentId(), you must provide a plain document ID, but '${n}' contains a '/' character.`);
  ...
  if (n instanceof Xc2) return we(t2, n._key);
...
function Xh(t2, e) {
  ...
  if (t2.length > 10) throw new L2(B2.INVALID_ARGUMENT, `Invalid Query. '${e.toString()}' filters support a maximum of 10 elements in the value array.`);
}
function Zh(t2, e, n) {
...
function gl(t2, e, n, ...s) {
  ...
  (e = getModularInstance(e)) || e instanceof eh ? Ih(r, "updateDoc", t2._key, e, n, s) : ph(r, "updateDoc", t2._key, e);
...
function Il(t2, ...e) {
  ...
  let c, a, h;
  if (t2 instanceof Xc2) a = jc2(t2.firestore, $a2), h = en(t2._key.path), c = {
    next: (n2) => {
      e[o] && e[o](Al(a, t2, n2));
    },
    error: e[o + 1],
    ...
    return t3.asyncQueue.enqueueAndForget(async () => {
      try {
        if (mu(await Ta2(t3))) {
          ...
          s.resolve(r);
        } else s.reject(new L2(B2.UNAVAILABLE, "Failed to get count result because the client is offline."));
      } catch (t4) {
        s.reject(t4);
      }
    }), s.promise;
...
function Fl(t2, e) {
  ...
  if (!(null === (n = s.offlineComponents) || void 0 === n ? void 0 : n.indexBackfillerScheduler)) return N2("Cannot enable indexes when persistence is disabled"), Promise.resolve();
  const i = function(t3) {
...
!function(t2, e = true) {
  ...
  }, "PUBLIC").setMultipleInstances(true)), registerVersion(b, "3.7.3", t2), // BUILD_TARGET will be replaced by values like esm5, esm2017, cjs5, etc during the compilation
